...
public class GenerateMainAction extends AnAction implements AnActionWithSyncUpdate {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        if (!PsiUtil.hasDefaultConstructor(psiClass)) {
            Messages.showMessageDialog(project, UIDesignerLocalize.generateMainNoDefaultConstructor().get(), UIDesignerLocalize.generateMainTitle().get(), Messages.getErrorIcon());
            return;
        }
